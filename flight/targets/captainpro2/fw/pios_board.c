...
static const struct pios_mpu60x0_cfg pios_mpu6050_cfg = {
	...
	.interrupt_cfg = PIOS_MPU60X0_INT_CLR_ANYRD | PIOS_MPU60X0_INT_I2C_BAYPASS_EN,
...
void PIOS_Board_Init(void) {
	...
	if (boot_count < 3) {
		...
		HwCaptainPro2SetDefaults(HwCaptainPro2Handle(), 0);
	...
	HwCaptainPro2USB_VCPPortGet(&hw_usb_vcpport);

	if (!usb_cdc_present) {
		/* Force VCP port function to disabled if we haven't advertised VCP in our USB descriptor */
		hw_usb_vcpport = HWCAPTAINPRO2_USB_VCPPORT_DISABLED;
	}
	...
	case HWCAPTAINPRO2_USB_VCPPORT_DISABLED:
		break;
	case HWCAPTAINPRO2_USB_VCPPORT_USBTELEMETRY:
		...
		break;
	case HWCAPTAINPRO2_USB_VCPPORT_COMBRIDGE:
#if defined(PIOS_INCLUDE_COM)
		{
...
#endif	/* PIOS_INCLUDE_COM */
		break;
	case HWCAPTAINPRO2_USB_VCPPORT_DEBUGCONSOLE:
#if defined(PIOS_INCLUDE_COM)
#if defined(PIOS_INCLUDE_DEBUG_CONSOLE)
		{
	...
	HwCaptainPro2USB_HIDPortGet(&hw_usb_hidport);

	if (!usb_hid_present) {
		/* Force HID port function to disabled if we haven't advertised HID in our USB descriptor */
		hw_usb_hidport = HWCAPTAINPRO2_USB_HIDPORT_DISABLED;
	}
	...
	case HWCAPTAINPRO2_USB_HIDPORT_DISABLED:
		break;
	case HWCAPTAINPRO2_USB_HIDPORT_USBTELEMETRY:
#if defined(PIOS_INCLUDE_COM)
		{
			uint8_t * rx_buffer = (uint8_t *) pvPortMalloc(PIOS_COM_TELEM_USB_RX_BUF_LEN);
			uint8_t * tx_buffer = (uint8_t *) pvPortMalloc(PIOS_COM_TELEM_USB_TX_BUF_LEN);
	...
	uint8_t hw_DSMxBind;
	HwCaptainPro2DSMxBindGet(&hw_DSMxBind);
	...
	/* Configure the rcvr / UART1 port */
	uint8_t hw_uart1;
	HwCaptainPro2RcvrUart1Get(&hw_uart1);
	switch (hw_uart1) {
	case HWCAPTAINPRO2_RCVRUART1_DISABLED:
		break;
	case HWCAPTAINPRO2_RCVRUART1_PWM:
#if 0 & defined(PIOS_INCLUDE_PWM)
		{
		...
		break;
	case HWCAPTAINPRO2_RCVRUART1_PPM:
		...
		break;
	case HWCAPTAINPRO2_RCVRUART1_DSM2:
	case HWCAPTAINPRO2_RCVRUART1_DSMX10BIT:
	case HWCAPTAINPRO2_RCVRUART1_DSMX11BIT:
		...
		break;
	case HWCAPTAINPRO2_RCVRUART1_HOTTSUMD:
	case HWCAPTAINPRO2_RCVRUART1_HOTTSUMH:
	...
	/* UART3 Port */
	uint8_t hw_uart3;
	HwCaptainPro2Uart3Get(&hw_uart3);
	switch (hw_uart3) {
	case HWCAPTAINPRO2_UART3_DISABLED:
		break;
	case HWCAPTAINPRO2_UART3_TELEMETRY:
...
#endif
		break;
	case HWCAPTAINPRO2_UART3_DEBUGCONSOLE:
...
#endif	/* PIOS_INCLUDE_DEBUG_CONSOLE */
		break;
	case HWCAPTAINPRO2_UART3_COMBRIDGE:
#if defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif
		break;
	case HWCAPTAINPRO2_UART3_MAVLINKTX:
		...
		break;
	case HWCAPTAINPRO2_UART3_MAVLINKTX_GPS_RX:
	...
	/* UART4 Port */
	uint8_t hw_uart4;
	HwCaptainPro2Uart4Get(&hw_uart4);
	switch (hw_uart4) {
	case HWCAPTAINPRO2_UART4_DISABLED:
		break;
	case HWCAPTAINPRO2_UART4_TELEMETRY:
#if defined(PIOS_INCLUDE_TELEMETRY_RF) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif /* PIOS_INCLUDE_TELEMETRY_RF */
		break;
	case HWCAPTAINPRO2_UART4_GPS:
#if defined(PIOS_INCLUDE_GPS) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
		PIOS_Board_configure_com(&pios_uart4_cfg, PIOS_COM_GPS_RX_BUF_LEN, 0, &pios_usart_com_driver, &pios_com_gps_id);
#endif
		break;
	case HWCAPTAINPRO2_UART4_DEBUGCONSOLE:
#if defined(PIOS_INCLUDE_DEBUG_CONSOLE) && defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
		PIOS_Board_configure_com(&pios_uart4_cfg, 0, PIOS_COM_DEBUGCONSOLE_TX_BUF_LEN, &pios_usart_com_driver, &pios_com_debug_id);
#endif	/* PIOS_INCLUDE_DEBUG_CONSOLE */
		break;
	case HWCAPTAINPRO2_UART4_COMBRIDGE:
#if defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM)
...
#endif
		break;
	case HWCAPTAINPRO2_UART4_MAVLINKTX:
#if defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM) && defined(PIOS_INCLUDE_MAVLINK)
		PIOS_Board_configure_com(&pios_uart4_cfg, 0, PIOS_COM_MAVLINK_TX_BUF_LEN, &pios_usart_com_driver, &pios_com_mavlink_id);
#endif	/* PIOS_INCLUDE_MAVLINK */
		break;
	case HWCAPTAINPRO2_UART4_MAVLINKTX_GPS_RX:
#if defined(PIOS_INCLUDE_USART) && defined(PIOS_INCLUDE_COM) && defined(PIOS_INCLUDE_MAVLINK) && defined(PIOS_INCLUDE_GPS)
		PIOS_Board_configure_com(&pios_uart4_cfg, PIOS_COM_GPS_RX_BUF_LEN, PIOS_COM_MAVLINK_TX_BUF_LEN, &pios_usart_com_driver, &pios_com_gps_id);
		pios_com_mavlink_id = pios_com_gps_id;
#endif	/* PIOS_INCLUDE_MAVLINK */
		break;
	}
	...
	HwCaptainPro2MPU6050DLPFGet(&hw_mpu6050_dlpf);
	enum pios_mpu60x0_filter mpu6050_dlpf = \
	    (hw_mpu6050_dlpf == HWCAPTAINPRO2_MPU6050DLPF_256) ? PIOS_MPU60X0_LOWPASS_256_HZ : \
	    (hw_mpu6050_dlpf == HWCAPTAINPRO2_MPU6050DLPF_188) ? PIOS_MPU60X0_LOWPASS_188_HZ : \
	    (hw_mpu6050_dlpf == HWCAPTAINPRO2_MPU6050DLPF_98) ? PIOS_MPU60X0_LOWPASS_98_HZ : \
	    (hw_mpu6050_dlpf == HWCAPTAINPRO2_MPU6050DLPF_42) ? PIOS_MPU60X0_LOWPASS_42_HZ : \
	    (hw_mpu6050_dlpf == HWCAPTAINPRO2_MPU6050DLPF_20) ? PIOS_MPU60X0_LOWPASS_20_HZ : \
	    (hw_mpu6050_dlpf == HWCAPTAINPRO2_MPU6050DLPF_10) ? PIOS_MPU60X0_LOWPASS_10_HZ : \
	    (hw_mpu6050_dlpf == HWCAPTAINPRO2_MPU6050DLPF_5) ? PIOS_MPU60X0_LOWPASS_5_HZ : \
	    pios_mpu6050_cfg.default_filter;
	PIOS_MPU6050_SetLPF(mpu6050_dlpf);

	uint8_t hw_mpu6050_samplerate;
	HwCaptainPro2MPU6050RateGet(&hw_mpu6050_samplerate);
	uint16_t mpu6050_samplerate = \
	    (hw_mpu6050_samplerate == HWCAPTAINPRO2_MPU6050RATE_200) ? 200 : \
	    (hw_mpu6050_samplerate == HWCAPTAINPRO2_MPU6050RATE_333) ? 333 : \
	    (hw_mpu6050_samplerate == HWCAPTAINPRO2_MPU6050RATE_500) ? 500 : \
	    (hw_mpu6050_samplerate == HWCAPTAINPRO2_MPU6050RATE_666) ? 666 : \
	    (hw_mpu6050_samplerate == HWCAPTAINPRO2_MPU6050RATE_1000) ? 1000 : \
	    (hw_mpu6050_samplerate == HWCAPTAINPRO2_MPU6050RATE_2000) ? 2000 : \
	    (hw_mpu6050_samplerate == HWCAPTAINPRO2_MPU6050RATE_4000) ? 4000 : \
	    (hw_mpu6050_samplerate == HWCAPTAINPRO2_MPU6050RATE_8000) ? 8000 : \
...
#if defined(PIOS_INCLUDE_HMC5883)
	{
		...
		HwCaptainPro2MagnetometerGet(&Magnetometer);

		if (Magnetometer == HWCAPTAINPRO2_MAGNETOMETER_EXTERNALI2C
			|| Magnetometer == HWCAPTAINPRO2_MAGNETOMETER_INTERNAL) {
			...
			HwCaptainPro2ExtMagOrientationGet(&ExtMagOrientation);

			enum pios_hmc5883_orientation hmc5883_orientation = \
				(ExtMagOrientation == HWCAPTAINPRO2_EXTMAGORIENTATION_TOP0DEGCW) ? PIOS_HMC5883_TOP_0DEG : \
				(ExtMagOrientation == HWCAPTAINPRO2_EXTMAGORIENTATION_TOP90DEGCW) ? PIOS_HMC5883_TOP_90DEG : \
				(ExtMagOrientation == HWCAPTAINPRO2_EXTMAGORIENTATION_TOP180DEGCW) ? PIOS_HMC5883_TOP_180DEG : \
				(ExtMagOrientation == HWCAPTAINPRO2_EXTMAGORIENTATION_TOP270DEGCW) ? PIOS_HMC5883_TOP_270DEG : \
				(ExtMagOrientation == HWCAPTAINPRO2_EXTMAGORIENTATION_BOTTOM0DEGCW) ? PIOS_HMC5883_BOTTOM_0DEG : \
				(ExtMagOrientation == HWCAPTAINPRO2_EXTMAGORIENTATION_BOTTOM90DEGCW) ? PIOS_HMC5883_BOTTOM_90DEG : \
				(ExtMagOrientation == HWCAPTAINPRO2_EXTMAGORIENTATION_BOTTOM180DEGCW) ? PIOS_HMC5883_BOTTOM_180DEG : \
				(ExtMagOrientation == HWCAPTAINPRO2_EXTMAGORIENTATION_BOTTOM270DEGCW) ? PIOS_HMC5883_BOTTOM_270DEG : \
